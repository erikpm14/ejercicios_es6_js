...
const totalExams = exams.reduce((sum, exam) => sum + exam.score, 0);

console.log("Suma total de las notas:", totalExams);

// 6.2 Dado el mismo array, haz una suma de todos las notas de los examenes de los 
// alumnos que esten aprobados usando la función .reduce().

const approvedTotal = exams.reduce((sum, exam) => {
    return exam.score >= 5 ? sum + exam.score : sum;
}, 0);

console.log("Suma total de las notas de los aprobados:", approvedTotal);
